  ...
  return (
    <div className="container mx-auto text-justify">
      ...
      >
        ...
        Australia , travel in and out of Australia work up to 48 hours a
        fortnight when your course of study or training is in session (students
        studying a masters by research or doctoral degree, and their families,
        have no work limit). See Work restrictions for student visa holders.
      </Typography>
      ...
      <Typography
        ...
        className="mb-12 !text-gray-500 font-my-font text-justify text-[26px] mt-12"
      >
        This is a temporary visa to study up to 5 years. The type of course and
        its length will determine the length of stay Primary school children
      ...
      <Typography className="mb-12 !text-gray-500 font-my-font text-justify text-[26px] mt-12">
        ...
        from your education provider with the date of your graduation. <br></br>
        <br></br>
        If you hold or held a student visa and completed specific qualifications
        in Australia in the last six months, you might be eligible for a
        Temporary Graduate visa (subclass 485). <br></br> <br></br>If you are a recent
        engineering graduate of a recognized institution you might be eligible
        for the Skilled Recognition Graduate visa (subclass 476). <br></br> <br></br>If
        you want to stay longer for other reasons, you must apply for a new visa
        that suits your circumstances. Explore your visa options.
      </Typography>
